...
class Women_Eyeglasses extends Component {
  ...
  constructor(props) {
	...
	render() {
        ...
        <img className="img-fluid" src="images/Header/Women-EyeGlasses-1-1.jpg" />
						...
						>
							<h1 style={{ textTransform: 'uppercase' }}>Women Eyeglasses</h1>
						</div>
					</div>
    ...
    <div className="row justify-content-center bg-secondary text-white">
      <div className="col-sm-12 justify-content-center">
        <p className="text-center mt-2 mb-1">
          Make a glamorous statement with our wide range of eyeglasses frames for women.
        </p>
...
export default Women_Eyeglasses;
