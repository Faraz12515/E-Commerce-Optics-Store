...
export class Moscot extends Component {
	//-------------------STRIPE------------------------//
			...
			<div>
				<div style={{ overflowX: 'hidden' }}>
					<div className='jumbotron'>
						<h1 className='text-center product'>MOSCOT</h1>
					</div>
							...
							<div className='col-md-5'>
								<Carousel>
									...
									<Carousel.Item>
										<img
											className='d-block w-100'
											src='images/Product Page/Moscot-1.jpg'
											alt='Third slide'
										/>
									</Carousel.Item>
									<Carousel.Item>
										<img
											className='d-block w-100'
											src='images/Product Page/Moscot-2.jpg'
											alt='Third slide'
										/>
									</Carousel.Item>
									<Carousel.Item>
										<img
											className='d-block w-100'
											src='images/Product Page/Moscot-3.jpg'
											alt='Third slide'
										/>
									</Carousel.Item>
									<Carousel.Item>
										<img
											className='d-block w-100'
											src='images/Product Page/Moscot-4.jpg'
											alt='Third slide'
										/>
									</Carousel.Item>
								</Carousel>
